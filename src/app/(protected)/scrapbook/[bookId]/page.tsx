...
export default function CanvasEditorPage() {
  ...
  const [_selectedText, setSelectedText] = useState<
    import("fabric").FabricObject | null
  >(null);
        ...
        if (
          ...
          if (pressDuration < LONG_PRESS_DURATION && !longPressTriggered) {
            ...
            textEditor.openEditor({
              ...
              textAlign:
                (textbox.textAlign as "left" | "center" | "right") || "center",
    ...
    >
      ...
      <div className="flex-1 flex overflow-hidden relative mt-1">
        ...
        <div
          ...
          onClick={(e) => {
            ...
            if (
              !target.closest('[class*="text-toolbar"]') &&
      ...
      <TextEditorOverlay
        ...
        onBgColorSelect={(color) =>
          textEditor.setStyles({ backgroundColor: color })
        }
